...
<html>
    <head>
        ...
        <title>Shopping Cart - BlindBoxStore</title>
        ...
        <div class="container mt-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body text-center py-5">
                    ...
                    <p>Looks like you haven't added any blindBoxs to your cart yet.</p>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="MainController?btAction=RemoveFromCart&productID=<%= item.getProductID() %>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to remove this item?')">
                    ...
                    <form action="MainController" method="POST">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="customerEmail" name="customerEmail" value="<%= userInfo != null ? userInfo.getEmail() : "" %>" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="customerPhone" class="form-label">Phone</label>
                                <input type="tel" class="form-control" id="customerPhone" name="customerPhone" value="<%= userInfo != null ? userInfo.getPhone() : "" %>" required>
                            </div>
                            <div class="col-md-6">
